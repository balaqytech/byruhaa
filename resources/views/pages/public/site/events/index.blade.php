...
@section('content')
    <section class="mx-auto w-full max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div class="public-hero-copy max-w-3xl">
            ...
            <h1 class="mt-4 font-heading text-4xl font-bold text-[#123329] sm:text-5xl dark:text-[#f7f1df]">تجارب مختارة بعناية</h1>
