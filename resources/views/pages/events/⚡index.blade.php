                ...
                <div class="flex h-full flex-col gap-5">
                    <div>
                        <div class="flex items-start justify-between gap-3">
                            <flux:badge class="bg-emerald-50 text-emerald-800 dark:bg-emerald-400/15 dark:text-emerald-100">{{ trans()->has("admin.event_types.{$event->type}") ? __("admin.event_types.{$event->type}") : ucfirst($event->type) }}</flux:badge>
