...
return [
    ...
    'phone' => 'يجب أن يكون :attribute صالحًا. للأرقام خارج عُمان، أضف رمز الدولة مسبوقًا بعلامة +.',
    ...
    'attributes' => [
        'address' => 'العنوان',
        'amount_omr' => 'مبلغ الشحن بالريال العُماني',
        'amount_baisa' => 'المبلغ بالبيسة',
        'area' => 'المنطقة',
