...
class UchatErrors
{
    ...
    public const REASONS = [
        ...
        'Wallets are currently unavailable.' => 'wallet_unavailable',
        'The wallet is not active.' => 'wallet_inactive',
        'A closed wallet cannot be changed through this endpoint.' => 'wallet_closed',
        'A wallet can only be activated for an active minor profile.' => 'minor_account_inactive',
        'Wallet spending can only be enabled for an active minor profile.' => 'minor_account_inactive',
