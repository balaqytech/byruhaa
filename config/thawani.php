...
$testCheckoutBaseUrl = $checkoutBaseUrl($env('THAWANI_TEST_CHECKOUT_BASE_URL', 'https://uatcheckout.thawani.om'));
$liveCheckoutBaseUrl = $checkoutBaseUrl($env('THAWANI_LIVE_CHECKOUT_BASE_URL', 'https://checkout.thawani.om'));
...
return [
    ...
    'test' => [
        'base_url' => $env('THAWANI_TEST_API_BASE_URL', 'https://uatcheckout.thawani.om/api/v1'),
    ...
    'live' => [
        'base_url' => $env('THAWANI_LIVE_API_BASE_URL', 'https://checkout.thawani.om/api/v1'),
